(function ($app) {
    ...
    app.controller('HomeController', ['$scope', '$http', '$rootScope', '$state', '$translate', 'Notification', 'calendar', function ($scope, $http, $rootScope, $state, $translate, Notification, calendar) {
